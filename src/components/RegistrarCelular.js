...
import FloatingLabel from "react-bootstrap/FloatingLabel";
>>>>>>> e4bfa5f7dc29466eccfebdd84705cdff49fd4e51
    ...
    <div className="container">
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          ...
          <Form.Group as={Col} md="3" controlId="InputlRam">
            <FloatingLabel controlId="InputlRam" label="RAM">
              <Form.Control required type="numer" placeholder="Modelo" />
            </FloatingLabel>
            <Form.Control.Feedback type="invalid">
              Campo obligatorio.
            </Form.Control.Feedback>
        ...
        <Row className="mb-3">
          <Form.Group as={Col} md="4" controlId="InputPeso">
            <FloatingLabel controlId="InputPeso" label="Peso">
              <Form.Control required type="number" placeholder="Peso" />
            </FloatingLabel>
            <Form.Control.Feedback type="invalid">
              Campo obligatorio.
            </Form.Control.Feedback>
          ...
          <Form.Group as={Col} md="4" controlId="InputBateriAmAh">
            <FloatingLabel controlId="InputBateriAmAh" label="Bateria mah">
              <Form.Control required type="numer" placeholder="Bateria mah" />
            </FloatingLabel>
            <Form.Control.Feedback type="invalid">
              Campo obligatorio.
            </Form.Control.Feedback>
